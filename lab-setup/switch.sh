...
# Add bridge ports
/interface bridge port add bridge=bridge30 interface=ether9 
/interface bridge port add bridge=bridge30 interface=ether13 
/interface bridge port add bridge=bridge31 interface=ether14

# Adding GNU4 eth1
/interface bridge port remove [find interface=ether16] 
/interface bridge port add bridge=bridge31 interface=ether16 